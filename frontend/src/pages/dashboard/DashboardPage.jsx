  ...
  if (loading)
    return (
      <div className="bg-white p-6 rounded-xl shadow">
        <p className="text-sol-blue font-semibold">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-xl shadow border-l-4 border-sol-blue">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Total de socios cargados en el sistema.
          </p>
        </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow space-y-3">
        ...
        <p className="text-gray-600">
          Integraremos gestión de planteles, eventos y reportes automáticos para
          que el club tenga toda la información en un solo lugar.
        </p>
